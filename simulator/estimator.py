...
class Estimator(torch.nn.Module):
    ...
    def forward(self, f, img_backward=True):
        ...
        local_index = (f * self.simulator.n_substeps[None]) % self.simulator.cuda_chunk_size
        print(">>>:", f)
        # print('V', self.simulator.v[10000, local_index], self.simulator.v[0, local_index], self.simulator.v[100000, local_index])
        print('C:', self.simulator.C[10000, local_index], self.simulator.C[0, local_index], self.simulator.C[100000, local_index])
        # print('F:', self.simulator.F[10000, f], self.simulator.F[0, f], self.simulator.F[100000, f])
