...
class GUI:
    def __init__(self, args, dataset, opt, pipe, testing_iterations, saving_iterations, n_keys, vel_start_time=0.0) -> None:
        ...
        self.deform = DeformModel(max_time=dataset.max_time, vel_start_time=vel_start_time, light=dataset.light, physics_code=dataset.physics_code)
